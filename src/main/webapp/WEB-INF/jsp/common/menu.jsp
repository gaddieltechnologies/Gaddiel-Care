...
<head>
<title>Menu</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<body style="margin:0px;background-color:rgb(255, 255, 255);"><noscript><span style="font-size:13px;font-family:arial;"><span style="color:#dd3300">Warning!</span>&nbsp&nbsp; MyCSSMenu may have been blocked by IE-SP2's active content option. This browser feature blocks JavaScript from running locally on your computer.<br><br>This warning will not display once the menu is on-line.  To enable the menu locally, click the yellow bar above, and select <span style="color:#0033dd;">"Allow Blocked Content"</span>.<br><br>To permanently enable active content locally...<div style="padding:0px 0px 30px 10px;color:#0033dd;"><br>1: Select 'Tools' --> 'Internet Options' from the IE menu.<br>2: Click the 'Advanced' tab.<br>3: Check the 2nd option under 'Security' in the tree (Allow active content to run in files on my computer.)</div></span></noscript>

<!-- MyCSSMenu Structure [Menu 0] -->

<ul id="qm0" class="qmmc">

	<li><a class="qmparent" href="${pageContext.request.contextPath}/login?flag=true">HOME</a></li>

	
	<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="javascript:void(0)">CONFIGURATION</a>

		<ul>
		<li><a href="${pageContext.request.contextPath}/ChurchConfiguration">Church Configuration</a></li>
		<li><a href="${pageContext.request.contextPath}/systemLookups">System Lookups</a></li>
		<li><a href="${pageContext.request.contextPath}/customLookups">Custom Lookups</a></li>
		<li><a href="${pageContext.request.contextPath}/Roles">Roles</a></li>
		<li><a href="${pageContext.request.contextPath}/rolesprivileges">Role Privileges</a></li>
		<li><a href="${pageContext.request.contextPath}/Contributionschedules">CollectionSchedule</a></li>
		</ul></li>

	
		<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="javascript:void(0)">FAMILY-MEMBER DETAILS </a>

		<ul style="width:150px;">
		<li><a href="${pageContext.request.contextPath}/familylanding">Family Details</a></li>
		<li><a href="${pageContext.request.contextPath}/Subscription">Subscription</a></li>
		</ul></li>
	
	
	
	<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="javascript:void(0)">REGISTERS </a>

		<ul style="width:150px;">
		<li><a href="${pageContext.request.contextPath}/Baptism">Baptism</a></li>
		<li><a href="${pageContext.request.contextPath}/underconstruction">First Communion</a></li>
		<li><a href="${pageContext.request.contextPath}/Confirmation">Confirmation</a></li>
		<li><a href="${pageContext.request.contextPath}/underconstruction">Catechism</a></li>
		<li><a href="${pageContext.request.contextPath}/Marriage">Marriage</a></li>
		<li><a href="${pageContext.request.contextPath}/Death">Death</a></li>
		<li><a href="${pageContext.request.contextPath}/Subscription">Subscription</a></li>
				<li><a href="${pageContext.request.contextPath}/Collectionregisters">Collectionregisters</a></li>
	...
	<li><a class="qmparent" href="javascript:void(0)">ACTIVITIES </a>
		...
		<ul style="width:150px;">
		<li><a href="${pageContext.request.contextPath}/underconstruction">Mass</a></li>
		<li><a href="${pageContext.request.contextPath}/underconstruction">Mass Intentions</a></li>
		<li><a href="${pageContext.request.contextPath}/underconstruction">Prayers</a></li>
		<li><a href="${pageContext.request.contextPath}/underconstruction">Prayer Intentions</a></li>
		</ul></li>
		...
		<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="javascript:void(0)">GROUP ACTIVITIES</a>

		<ul style="width:150px;">
		<li><a href="${pageContext.request.contextPath}/underconstruction">Parish Council</a></li>
		</ul></li>

	<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="${pageContext.request.contextPath}/underconstruction">REPORTS </a>

				<li><span class="qmdivider qmdividery" ></span></li>
	<li><a class="qmparent" href="javascript:void(0)">FINANCE </a>
		<ul style="width:150px;">
		<li><a href="${pageContext.request.contextPath}/underconstruction">Income</a></li>
		<li><a href="${pageContext.request.contextPath}/underconstruction">Expenses</a></li>
		<li><a href="${pageContext.request.contextPath}/underconstruction">Assests</a></li>
		</ul></li>
			
		<li><span class="qmdivider qmdividery" ></span></li>
		<li><a class="qmparent" href="${pageContext.request.contextPath}/index">SIGN OUT</a></li>
