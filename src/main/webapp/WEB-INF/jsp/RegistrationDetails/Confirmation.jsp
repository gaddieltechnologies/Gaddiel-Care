...
<form:form commandName="Confirmation" action="" id="familLanding">
<body>
...
<table width="100%" border="0" style="border-collapse:collapse;">
  <tr style="background-image:url(${pageContext.request.contextPath}/resources/images/glossyback.gif);">
    <td width="20%"><strong>&nbsp;Confirmation Details</strong></td>
     <td width="10%">&nbsp;</td>
      <td width="18%">&nbsp;</td>
 ...
 <tr  style="background-image:url(${pageContext.request.contextPath}/resources/images/glossyback22.gif);">
     <td width="5%">Name</td>
    <td width="8%">SurName</td>
    <td width="6%">Gender</td>
    <td width="9%">Date of Birth</td>
    <td width="8%">Place of Birth</td>
    <td width="9%">Father Name</td>
    <td width="11%">Mother Name</td>
    <td width="13%">Parent  Occupation</td>
  ...
  <tr onClick="HighLightTR(this,'#DCFAFA','#DCFAFA');">
    ...
    <td class="td" width="8%">Fernandes</td>
    <td class="td" width="6%">Male</td>
    <td class="td" width="9%">11-12-1986</td>
    <td class="td" width="8%">Trichy</td>
    <td class="td" width="9%">Jinto</td>
    <td class="td" width="11%">Mary</td>
    <td class="td" width="13%">Accountant</td>
    <td class="td" width="9%">Trichy</td>
    <td class="td" width="10%">Indian</td>
	<td class="td" width="12%"></td>
  </tr>
  </table>
  </div>
...
function openwindow()
{
	var url = "<c:url value='/Confirmation/ConfirmationPopupAdd' />";
...
{
	var url1 = "<c:url value='/Confirmation/ConfirmationPopupEdit' />";
