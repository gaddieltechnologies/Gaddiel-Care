...
<table width="610" >	
  <tr>
    ...
    <td width="149"><input type="text" value="Sundar Nagar"/></td>
    <td width="110">Area</td>
    <td width="201"><input type="text" value="Renga Nagar 1st Road"/></td>
  </tr>
  <tr>
    <td>Collector</td>
    <td><input type="text" value="Raju"/></td>
  ...
  <tr>
   <td>Date of Payment</td>
    <td><input type="text" value="24-4-2011 "/></td>
    <td>Receipt Number</td>
    <td><input type="text" value="522"/></td>
  </tr>
  <tr>
    <td>Payment For</td>
