...
<form:form commandName="Marriage" action="" id="familLanding">
<body>
...
<table width="100%" border="0" style="border-collapse:collapse;">
  <tr style="background-image:url(${pageContext.request.contextPath}/resources/images/glossyback.gif);">
    <td width="20%"><strong>&nbsp;Marriage Details</strong></td>
     <td width="10%">&nbsp;</td>
      <td width="18%">&nbsp;</td>
 ...
 <tr  style="background-image:url(${pageContext.request.contextPath}/resources/images/glossyback22.gif);">
    <td width="9%">Groom Name</td>
    <td width="16%">Conditon (Bachelor/Widower)</td>
    <td width="11%">Occupation</td>
    <td width="8%">Religion</td>
    <td width="11%">Bride name</td>
    <td width="6%">Age</td>
    <td width="15%">Conditon (Spinster/Widow)</td>
    <td width="12%">Occuption</td>
  ...
  <tr onClick="HighLightTR(this,'#DCFAFA','#DCFAFA');">
    <td class="td" width="9%">Sijo</td>
    <td class="td" width="16%">Bachelor</td>
    <td class="td" width="11%">Accountant</td>
    <td class="td" width="8%">Chirstianity </td>
    <td class="td" width="11%">Ritu</td>
    <td class="td" width="6%">28</td>
    <td class="td" width="15%">Spinster</td>
    <td class="td" width="12%">Accountant</td>
    <td class="td" width="12%">Chirstianity</td>
   </tr>
  </table>
  </div>
...
function openwindow()
{
	var url = "<c:url value='/Marriage/MarriagePopupAdd' />";
...
{
	var url1 = "<c:url value='/Marriage/MarriagePopupEdit' />";
