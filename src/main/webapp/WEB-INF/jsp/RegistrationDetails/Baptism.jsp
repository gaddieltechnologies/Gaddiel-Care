...
<form:form commandName="Baptism" action="" >
<body>
...
<table width="100%" border="0" style="border-collapse:collapse;">
  <tr style="background-image:url(${pageContext.request.contextPath}/resources/images/glossyback.gif);">
    <td width="20%"><strong>&nbsp;Baptism Details</strong></td>
     <td width="10%">&nbsp;</td>
      <td width="18%">&nbsp;</td>
...
function openwindow()
{
	var url = "<c:url value='/Baptism/BaptismPopupAdd' />";
...
{
	var url1 = "<c:url value='/Baptism/BaptismPopupEdit' />";
