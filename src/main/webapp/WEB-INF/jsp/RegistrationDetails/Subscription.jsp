...
<form:form commandName="Subscription" action="" id="familLanding">
<body>

	   <style>
    #rowScroll { height: 100px; } /* Subtract the scrollbar height */

    #contentScroll { height: 300px; width: 98%; }
...
<fieldset style=" width:99%; height:430px; ">
...
<table width="100%" border="0" style="border-collapse:collapse;">
  <tr style="background-image:url(${pageContext.request.contextPath}/resources/images/glossyback.gif);">
    <td width="20%"><strong>&nbsp;Subscription Details</strong></td>
     <td width="10%">&nbsp;</td>
      <td width="18%">&nbsp;</td>
 ...
 <tr  style="background-image:url(${pageContext.request.contextPath}/resources/images/glossyback22.gif);">
    <td width="11%">Zone</td>
    <td width="8%">Area</td>
    <td width="12%">Collector</td>
    <td width="12%">Pending Payments</td>
    <td width="12%">Date of Payment</td>
    <td width="11%">Receipt Number</td>
    <td width="12%">Payment For</td>
    <td width="11%">Payment to</td>
  ...
  <tr onClick="HighLightTR(this,'#DCFAFA','#DCFAFA');">
    <td class="td" width="11%">Sundar Nagar</td>
    <td class="td" width="9%">Trichy</td>
    <td class="td" width="11%">Raju</td>
    <td class="td" width="12%">4 </td>
    <td class="td" width="12%">21-2-2012</td>
    <td class="td" width="11%">233</td>
    <td class="td" width="12%">Jmp</td>
...
function openwindow()
{
	var url = "<c:url value='/Subscription/SubscriptionPopupAdd' />";
...
{
	var url1 = "<c:url value='/Subscription/SubscriptionPopupEdit' />";
